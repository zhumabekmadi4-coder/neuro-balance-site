...
// Static param generation for export
...
export default async function ServicePage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <main className="min-h-[100dvh] bg-background relative overflow-hidden pb-20">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
                ...
                <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-accent/10 rounded-full blur-[120px] opacity-30 animate-pulse-glow" style={{ animationDelay: "1s" }} />
            </div>
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="pt-6">
                            <Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg shadow-primary/25 rounded-full px-8">
                                Записаться на прием
                            </Button>
                        </div>
                    </div>
